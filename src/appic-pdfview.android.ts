  ...
  export class AppicPdfView extends AppicPdfViewCommon {
    ...
    public loadPDF(src: string): Promise<any> {
      ...
      return Promise.resolve()
        .then(() => {
          console.log("AppicPdfViewCommon Android (Step 1) Clear cache: " + src);
          return this.tempFolder.clear();
        })
        .then(() => {
          console.log("AppicPdfViewCommon Android (Step 2) Download: " + src);
        ...
        .then(src => {
          console.log("AppicPdfViewCommon Android (Step 3) Download ok: " + src);
          if (src.indexOf("~") >= 0) {
          ...
          console.log("AppicPdfViewCommon Android (Step 4) Resolved local path: " + src);
        ...
        let onLoadHandler = (() => {
          ...
          return new pdfviewer.listener.OnLoadCompleteListener({
            loadComplete: numPages => {
              console.log("AppicPdfViewCommon Android (Step 5) Pages loaded: " + numPages);
